...
def main():
    ...
    def callback(ch, method, properties, body):
        ...
        visitas=pageviewapi.period.avg_last('es.wikipedia',consulta, last=30)
        #print("vistas del mes: "%visitas)
        print("Han habido {visitas} visitas los últimos 30 dias".format(visitas=visitas))
